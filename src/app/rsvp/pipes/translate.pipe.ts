...
export class TranslatePipe implements PipeTransform {
    public map: Record<string, string> = {
        ...
        [Starters.GOATS_CHEESE]: 'Walnut crushed goats cheese terrine, rocket and balsamic salad',
        [Mains.PORK]: 'Roast pork loin, fondant potato, wilted baby gem, crispy bacon, garlic cream peas',
        [Mains.CHICKEN]: 'Roast breast of chicken, dauphinoise potatoes, green beans, mushroom fricassee',
        [Mains.TAGINE]: 'Moroccan vegetable and apricot tagine, pine nut and raisin cous-cous raita and flatbread',
